...
public void ActualizarTabla() {
    ...
    private void initComponents() {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(1).setHeaderValue("periodo");
            jTable1.getColumnModel().getColumn(2).setHeaderValue("fundacion");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("numero facultades");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("codigo");
        }
